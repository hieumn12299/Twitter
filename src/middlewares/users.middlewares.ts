...
export const verifiedUserValidator = (req: Request, _res: Response, next: NextFunction) => {
  ...
  if (verify !== UserVerifyStatus.Verified) {
    //NOTE: Nếu đồng bộ thì dùng throw new Error sẽ chuyển sang Error handler, Nếu bất đồng bộ thì nên sử dụng return next(new ErrorWithStatus(...)) đển chuyển sang Error handler ngay lập tức
    throw new ErrorWithStatus({
